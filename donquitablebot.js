...
class donquitableBOT extends Client {
  constructor(options) {
    super(options);
...
const init = async () => {
  ...
  client.logger.log(`Chargement de ${cmdsFiles.length} catégories de commandes.`, "log");
...
client
  .on("disconnect", () => client.logger.warn("Le bot se déconnecte..."))
  .on("reconnecting", () => client.logger.log("Le bot se reconnecte...", "log"))
